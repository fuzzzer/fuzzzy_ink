...
## The Core Concept
Fuzzzy Ink is not a traditional chat app that connects directly over a network or server. Instead, it is a **personal, offline encryption system** disguised as a chat interface. 
