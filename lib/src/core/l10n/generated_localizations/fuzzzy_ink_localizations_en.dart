...
class FuzzzyInkLocalizationsEn extends FuzzzyInkLocalizations {
  FuzzzyInkLocalizationsEn([String locale = 'en']) : super(locale);
  ...
  @override
  String get welcomeToFuzzzyInk => 'Welcome to Fuzzzy Ink';
